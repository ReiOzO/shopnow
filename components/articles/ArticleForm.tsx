...
interface ArticleFormProps {
    initialData?: ArticleType | null; //Must have "?" to make it optional
}
        ...
        <div className="p-10">
            {initialData ? (
                <div className="flex items-center justify-between">
                    ...
                    <Delete id={initialData._id} item="article" />
                </div>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea placeholder="Description" {...field} rows={15} onKeyDown={handleKeyPress} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
